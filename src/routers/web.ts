...
import { getCartPage, getProductPage, postAddProductToCart, getCheckOutPage, postHandleCartToCheckout, postPlaceOrder, postThanksPage, getOrderHistoryPage, postAddToCartFromDetailPage } from 'src/controllers/client/productController';
